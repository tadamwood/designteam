<?php include('header.php');?>
		...
		<div class="center-container">
			...
			<div class="flip-container">
				...
				<div id="flip-content">
					<p id="fit-content">The advantage of working with a personal coach is the expertise of connecting you with the right program to get started in harmony with what your goals are.  You receive ongoing support not only from me but also your Team Beachbody family!  The folks at Beachbody have done the scientific research to bring us fitness options for EVERY type of individual – young and old – beginner or expert.

Online coaching is very successful!  As a Team Beachbody online coach I conduct virtual challenge groups on Facebook.  I have challengers from all over the United States as well as Canada and the Philippines.  Through these challenge groups I provide daily trainer videos and tips, nutrition tips, recipes, motivation and inspiration to keep going.  The rewards are many – and I have made new friends along the way!
